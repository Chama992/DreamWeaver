...
public class PlayerEntityController : MonoBehaviour
{
    ...
    [Tooltip("wallcheck box collisiton up point")]
    ...
    {
        bool isBoxGround = Physics2D.BoxCast(groundCheckPoint.position, new Vector2(groundCheckWidth,groundCheckHeight), 0, Vector2.down, 0, whatIsGround);
        return isBoxGround;
    }
